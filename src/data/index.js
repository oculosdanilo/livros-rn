const DATA = [
...

    {
        ...
        Preço: "46,66 - Capa Dura",
        Genero: "Ficção Gótica e Romance Filosófico ",
        Paginas: "352",
        Avaliacao: "4,6",
        imagem: require("../Img/retrato.png"),
    },
...

    {
        ...
        Preço: "22,94 Capa Comum",
        Genero: "Ficção",
        Paginas: "360",
        Avaliacao: "4,6",
        imagem: require("../Img/estrelas.png"),
    },

    {
        id: "08",
        nome: "A Filha do Alquimista",
        descricao: "A narrativa, ambientada no século XXI, e com relatos em flash-back datados do século XV e seguintes, conta a história de Lys e sua aventura à procura de um pequeno cálice que pertenceu ao seu bisavô, foi escondido por sua avó e depois roubado de um navio naufragado na região. Tudo se liga a segredos muito antigos, dos tempos em que alquimistas de Toledo, na Espanha do século XV, tentavam escapar à Inquisição e descobrir a fórmula da vida eterna. Pablo, um jovem do litoral de Ilhabela, em São Paulo, se apaixona por Lys. O jovem casal enfrentará grandes perigos. Embora os alquimistas não existam mais, certos inimigos , assim como a intolerância e a sede de poder, nos ameaçam até hoje.",
        Preço: "48,45 Capa Comum",
...

    {
        id: "12",
        nome: "One Piece",
        descricao: "A tripulação pirata mais famosa dos quadrinhos finalmente joga sua âncora de novo no Brasil! Com roteiro e arte de Eiichiro Oda, o mangá de maior sucesso de todos os tempos retorna ao país, agora sob a bandeira Planet Mangá, da Panini Comics! Para ser o rei dos piratas, Luffy, o homem-borracha, precisa reunir uma tripulação e encontrar o maior de todos os tesouros. No caminho, enfrentará a Marinha, monstros, e muitos outros piratas que têm o mesmo objetivo. Então prepare-se pra encarar os perigos dos mares. A maior aventura de todas vai recomeçar!",
        Preço: "29,70 Capa Comum",
